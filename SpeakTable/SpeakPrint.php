...
<body>
<header>Speak Table</header>
<div id="navigation">
    <a id='nav' href="SpeakInput.html">Insert</a>
    <a id='nav' href="SpeakDel.html">Delete</a>
    <a id='nav' href="SpeakUpdate.html">Update</a>
...
$query = "select * from speak order by regdate desc limit $frow, $line_page";
$result = mysqli_query($conn,$query);
