...
$selectData = "SELECT kl,cl,el,rl,regdate FROM speak WHERE id='$id'";
...
if($row = mysqli_fetch_assoc($resultData)){
    ...
    $updateData = "UPDATE speak SET kl='$u_kl',cl='$u_cl',el='$u_el', rl='$u_rl',regdate='$u_date' WHERE id='$id'";
    ...
    if($updateQuery){
        ...
        echo "<script> 
        alert('다시 입력해주세요!');
        location.href='SpeakUpdate.html';
        </script>";
    } 
}else{
    echo "<script> 
    alert('해당 ID가 존재하지 않습니다. ID를 다시입력해주세요!');
    location.href='SpeakUpdate.html';
    </script>";
} 
mysqli_close($conn);
